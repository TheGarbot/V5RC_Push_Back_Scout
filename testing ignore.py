...
# EPA Hyperparameters (Statbotics methodology)
INITIAL_EPA = 0.0       # Teams start at 0 EPA
INITIAL_RATING = 0.0    # Teams start at 0 rating (same as INITIAL_EPA)
K_FACTOR = 12.0         # Learning rate for qualification matches
K_FACTOR_PLAYOFF = 4.0  # Learning rate for playoff matches (lower than qual)
K_QUAL = 12.0           # Alternative name for K_FACTOR
K_PLAYOFF = 4.0         # Alternative name for K_FACTOR_PLAYOFF
...
S = 1.0                 # Scaling factor for converting ratings to EPA
...
def get_epa_rankings():
    ...
    epa_ratings = {team: rating * S for team, rating in R.items()}
